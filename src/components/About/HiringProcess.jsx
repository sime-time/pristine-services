  ...
  return (
    <>
      ...
      <div className="timeline container">
        ...
        <HiringStep icon={<FaSearch />} title="Background Check" isLeft={false} content="We will conduct a thorough background check to ensure all candidates meet our standards and requirements." />
