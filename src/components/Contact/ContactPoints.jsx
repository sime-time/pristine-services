...
function ContactPoints() {
  return (
    <div className="contact-points d-flex flex-column justify-content-around gap-3 w-100 fs-5 mb-5 align-items-center">
      <h3 className="display-6 text-center">Reach out to us</h3>
