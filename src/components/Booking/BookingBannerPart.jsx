function BookingBannerPart({ mainText, subText }) {
  ...
  return (
    <div className={`d-flex flex-column align-items-center p-3 justify-content-around flex-fill ${isSubTotal ? 'text-primary' : 'bg-body-secondary border border-light'}`}>
      {mainTextHtml}
